...
import (
	...
	"github.com/cdktn-io/cdktn-provider-time-go/time/v14/staticresource/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/time/0.14.1/docs/resources/static time_static}.
...
func (j *jsiiProxy_StaticResource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StaticResource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StaticResource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StaticResource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StaticResource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/time/0.14.1/docs/resources/static time_static} Resource.
...
func (j *jsiiProxy_StaticResource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StaticResource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StaticResource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StaticResource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StaticResource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StaticResource) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StaticResource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StaticResource) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StaticResource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StaticResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
