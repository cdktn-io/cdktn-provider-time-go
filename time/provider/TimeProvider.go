...
import (
	...
	"github.com/cdktn-io/cdktn-provider-time-go/time/v14/provider/internal"
	"github.com/cdktn-io/cdktn-provider-time-go/time/v14/providerfunctions"
...
type TimeProvider interface {
	...
	Functions() providerfunctions.TimeProviderFunctions
	// Experimental.
...
func (j *jsiiProxy_TimeProvider) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_TimeProvider) Functions() providerfunctions.TimeProviderFunctions {
	var returns providerfunctions.TimeProviderFunctions
	_jsii_.Get(
		j,
		"functions",
		&returns,
...
func (j *jsiiProxy_TimeProvider) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func TimeProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_TimeProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TimeProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
