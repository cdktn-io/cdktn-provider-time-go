// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for time.
...
// You can continue to use the time provider in your CDK for Terraform projects with newer versions of CDKTF,
